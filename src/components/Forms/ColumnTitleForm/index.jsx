...
import { fetchColumnChangeTitle } from "../../../redux/slices/columns";
import { showSnackbar } from "../../../redux/slices/snackbar";
import styles from "./ColumnTitleForm.module.scss";

export const ColumnTitleForm = ({ id, title, setIsEditTitle }) => {
  ...
  const onSubmit = async (values) => {
    try {
      if (oldTitle !== values.title) {
        ...
        const data = await dispatch(fetchColumnChangeTitle({ id, values }));
